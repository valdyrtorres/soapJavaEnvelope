...
@XmlRootElement(name = "Acknowledgement", namespace = "http://www.tools.com/spring/soap/api/loanEligibility")
public class Acknowledgement {
    ...
    @XmlElement(name = "CriteriaMismatch", namespace = "http://www.tools.com/spring/soap/api/loanEligibility", required = true)
